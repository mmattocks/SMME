...
class TestHeModelInduction32 : public AbstractCellBasedTestSuite
{
public:
    ...
    const unsigned startSeed = 10000;
    const unsigned endSeed = 12999;
    ...
    const double inductionTime = 32.0;
    const std::string inductionTimeString = "32";
    ...
    void TestHeInductionCount32Fixture()
    {
        Timer::Reset();
    ...
    void TestDeterministicModelInduction32Fixture()
    {
        Timer::Reset();
