#ifndef OFFLATTICESIMULATIONPROPERTYSTOP_HPP_
#define OFFLATTICESIMULATIONPROPERTYSTOP_HPP_
...
class OffLatticeSimulationPropertyStop : public AbstractCellBasedSimulation<ELEMENT_DIM, SPACE_DIM>
{
private:
...
public:
     ...
     *     from an archive)
     */
    OffLatticeSimulationPropertyStop(AbstractCellPopulation<ELEMENT_DIM, SPACE_DIM>& rCellPopulation,
                                     bool deleteCellPopulationInDestructor = false, bool initialiseCells = true);

    void SetStopProperty(boost::shared_ptr<AbstractCellProperty> stopPropertySetting);

    bool HasStoppingEventOccurred();
     ...
     */
    void AddCellPopulationBoundaryCondition(
            boost::shared_ptr<AbstractCellPopulationBoundaryCondition<ELEMENT_DIM, SPACE_DIM> > pBoundaryCondition);
...
inline void save_construct_data(Archive & ar, const OffLatticeSimulationPropertyStop<ELEMENT_DIM, SPACE_DIM> * t,
 ...
 */
template<class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
inline void load_construct_data(Archive & ar, OffLatticeSimulationPropertyStop<ELEMENT_DIM, SPACE_DIM> * t,
                                const unsigned int file_version)
{
    ...
    ::new (t) OffLatticeSimulationPropertyStop<ELEMENT_DIM, SPACE_DIM>(*p_cell_population, true, false);
}
}
} // namespace

#endif /*OFFLATTICESIMULATIONPROPERTYSTOP_HPP_*/
